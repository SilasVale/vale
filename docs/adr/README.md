...
| [proposal-scoped-relay-token](proposal-scoped-relay-token.md) | Proposal (unnumbered, round-356) | F3 decision material: split daily relay use from the admin token (options A–D, B recommended); needs human sign-off before any implementation |
