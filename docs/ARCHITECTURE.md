...
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 441 feat-gated terminal,keyring (recounted R103: 392 lib — +9 evidence-feed R98, +4 busy-marker R99, +7 result-cap R100, +3 failure-envelope R101, +2 auth-coverage R102 (corrected from 3: that round modified one test and added two) — + 6 bin + 2 dep-surface + 27 + 1 + 2 + 7 + 1 + 3 router-auth integration; default-config lib 385; xwin gate re-verified R98–R103; suite green) |
