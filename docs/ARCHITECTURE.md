...
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 438 feat-gated terminal,keyring (recounted R102: 392 lib — +9 evidence-feed R98, +4 busy-marker R99, +7 result-cap R100, +3 failure-envelope R101, +3 auth-coverage R102 — + 6 bin + 2 dep-surface + 27 + 1 + 2 + 7 + 1 integration; default-config lib 385; xwin gate re-verified R98–R102; suite green) |
