...
|---|---|---|
| gateway | tsc + eslint(src+ui) + prettier + node --test | 307 |
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 248 (211 lib + 27 + 2 + 7 + 1 integration; 217 lib feat-gated) |
