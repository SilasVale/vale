...
|---|---|---|
| gateway | tsc + eslint(src+ui) + prettier + node --test | 299 |
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 238 (202 lib + 27 + 2 + 6 + 1 integration; 208 lib feat-gated) |
