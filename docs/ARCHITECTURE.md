...
|---|---|---|
| gateway | tsc + eslint(src+ui) + prettier + node --test | 409 |
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 340 (283 lib + 5 bin + 27 + 2 + 7 + 1 integration + 15 core; 289 lib feat-gated) |
