...
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 435 feat-gated terminal,keyring (recounted R101: 389 lib — +9 evidence-feed R98, +4 busy-marker R99, +7 result-cap R100, +3 failure-envelope R101 — + 6 bin + 2 dep-surface + 27 + 1 + 2 + 7 + 1 integration; default-config lib 382; xwin gate re-verified R98–R101; suite green) |
