...
|---|---|---|
| gateway | tsc + eslint(src+ui) + prettier + node --test | 562 |
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 349 (290 lib + 5 bin + 27 + 2 + 7 + 1 integration + 15 core; 298 lib feat-gated) |
