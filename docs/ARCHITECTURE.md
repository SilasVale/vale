...
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 432 feat-gated terminal,keyring (recounted R100: 386 lib — +9 evidence-feed pins R98, +4 busy-marker R99, +7 result-cap R100 — + 6 bin + 2 dep-surface + 27 + 1 + 2 + 7 + 1 integration; default-config lib 379; xwin gate re-verified R98/R99/R100; suite green) |
