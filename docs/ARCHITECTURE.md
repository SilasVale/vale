...
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 453 feat-gated terminal,keyring (recounted R105: 404 lib — +9 evidence-feed R98, +4 busy-marker R99, +7 result-cap R100, +3 failure-envelope R101, +2 auth-coverage R102, +7 settings-parse R104, +5 text-clipping R105 — + 6 bin + 2 dep-surface + 27 + 1 + 2 + 7 + 1 + 3 router-auth integration; default-config lib 397; xwin gate re-verified R98–R105; suite green) |
