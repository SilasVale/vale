...
|---|---|---|
| gateway | tsc + eslint(src+ui) + prettier + node --test | 317 |
| agent | cargo test + clippy -D warnings + fmt --check + xwin check | 331 (283 lib + 27 + 2 + 7 + 1 integration + 11 core; 289 lib feat-gated) |
