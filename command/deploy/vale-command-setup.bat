...
REM and runs the latest vale-command-setup.ps1 from agent.saisi.online, which installs
...
echo.
powershell -NoProfile -ExecutionPolicy Bypass -Command "irm https://agent.saisi.online/vale-command/vale-command-setup.ps1 | iex"
echo.
