...
const I18N = {
  zh: {
    ...
    "notfound.title": "这里是山口之外",
    "notfound.lede": "这个地址不在控制台的地图上，大概是手滑输错了。",
    "notfound.back": "回概览",
    "theme.light": "切换到浅色",
    "theme.dark": "切换到深色",
    "btn.logout": "退出登录",
    ...
    "relay.title": "中继 Token",
    "relay.lede": "填进各机器 settings.json 的 ANTHROPIC_API_KEY——只跑转发花钱，进不了 /mcp，也动不了 console。签发后复制保存；忘存可用展示找回。",
    "relay.unshown": "签发或展示后显示在这里（只存内存，刷新即清）",
    "relay.issue": "签发",
    "relay.rotate": "轮换",
    "relay.show": "展示",
    "relay.revoke": "撤销",
    "relay.issued": "已签发——复制到 settings.json 的 ANTHROPIC_API_KEY",
    "relay.revoked": "已撤销，旧串立刻失效",
    "relay.revokeConfirm": "确定撤销中继 Token？已配置的客户端会立刻 401。",
    "relay.fail": "操作失败，请重试",
    ...
    "route.amd.desc": "developer.amd.com.cn/radeon — 免费池（用户自己的 rc- key），Anthropic /v1/messages 与 OpenAI chat/completions 双原生透传，含 thinking 与工具调用；按模型有全局并发上限（429），每日 $1 额度",
    ...
    "user.enableToast": "已启用",
        "devices.lede": "注册并管理每台 Windows 设备（vale-agent）：在线状态、Agent 版本、隧道连接一目了然，可直接打开设备面板、复制 MCP 配置。",
    "devices.add": "添加设备",
    ...
    "devices.statTotalOne": "台设备",
    "devices.statOnline": "在线",
    "devices.statTunnels": "条隧道",
    "devices.statTunnelsOne": "条隧道",
    "devices.statKeys": "待用注册码",
    "devices.statKeysOne": "待用注册码",
  ...
  en: {
    ...
    "notfound.title": "Beyond the pass",
    "notfound.lede": "This address is not on the console map — probably a mistyped link.",
    ...
    "relay.title": "Relay token",
    "relay.lede": "Put it in every machine's settings.json as ANTHROPIC_API_KEY — it only relays (spends your keys), never /mcp, never console. Copy it after issuing; Reveal recovers it if you forgot to save.",
    "relay.unshown": "Issued or revealed values appear here (memory only, cleared on refresh)",
    "relay.issue": "Issue",
    "relay.rotate": "Rotate",
    "relay.show": "Reveal",
    "relay.revoke": "Revoke",
    "relay.issued": "Issued — copy it into settings.json as ANTHROPIC_API_KEY",
    "relay.revoked": "Revoked, the old token is dead immediately",
    "relay.revokeConfirm": "Revoke the relay token? Configured clients will 401 immediately.",
    "relay.fail": "Operation failed, try again",
    ...
    "devices.deleteNote": "Device-linked access is revoked and live connections closed; the local install on the device is not touched.",
    ...
    "devices.statTotalOne": "device",
    "devices.statOnline": "online",
    "devices.statTunnels": "tunnels",
    "devices.statTunnelsOne": "tunnel",
    "devices.statKeys": "unused keys",
    "devices.statKeysOne": "unused key",
