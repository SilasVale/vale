...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      "devices.namePh": "设备名（如 d1）", "devices.hostPh": "d1.command.saisi.online", "devices.tokenPh": "Bearer token（安装时生成）",
    ...
    en: {
      ...
      "devices.namePh": "Device name (e.g. d1)", "devices.hostPh": "d1.command.saisi.online", "devices.tokenPh": "Bearer token (from install)",
