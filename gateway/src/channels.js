...
export const VERIFY_PATH = "/v1/messages";
export const OG_ZEN_ANTHROPIC = "https://opencode.ai/zen/go" + VERIFY_PATH;
export const OG_ZEN_CHAT = "https://opencode.ai/zen/go/v1/chat/completions";
...
export const OG_NATIVE_ANTHROPIC = new Set(["deepseek-v4-flash"]);
...
export const HEALTH_PRIORITY = ["qw", "ds", "og", "or"];
