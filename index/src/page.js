...
const safeSetup = escHtml(safePageUrl(setupUrl, "/vale-agent/ValeAgent-Setup.exe"));
return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
